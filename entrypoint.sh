...
then
    case "$TRANSMISSION_WEB_UI" in
        ...
        shift)
            ...
            wget -qO- https://github.com/killemov/Shift/archive/master.tar.gz \
                | tar xz --strip-components=1 -C "$TRANSMISSION_WEB_HOME"
            ;;
        transmissionic)
            echo "Installing transmissionic UI !"
            wget -qO- https://github.com/6c65726f79/Transmissionic/releases/download/v1.8.0/Transmissionic-webui-v1.8.0.zip \
        ...
        transmission-web-control)
            ...
            wget -qO- https://github.com/ronggang/transmission-web-control/archive/refs/heads/master.tar.gz \
